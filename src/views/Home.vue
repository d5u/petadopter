<template>
  <div class="home-view-container">
    ...
    <b-form @submit.prevent="handleSubmit" v-if="showPetForm">
      ...
      <b-form-group id="input-group-5" label="Pet's Color:" label-for="input-5">
        <b-form-input
          id="input-5"
          type="string"
      ...
      <b-form-group id="input-group-6" label="Pet's Weight:" label-for="input-6">
        <b-form-input
          id="input-6"
          type="number"
      ...
      <b-form-group id="input-group-8" label="Notes:" label-for="input-8">
        <b-form-input
          id="input-8"
          type="string"
      ...
      <b-form-group id="input-group-9" label="Species:" label-for="input-9">
        <b-form-select
          id="input-9"
